...
/**
 * @file SHA256 implementation from:
 * https://www.programmingalgorithms.com/algorithm/sha256/cpp/
 */

#ifndef OOP_L7_HASH_H
#define OOP_L7_HASH_H
...
static string SHA256(const char *data) {
